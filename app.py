...
# আগের AccountPersonalShow এর বদলে এখন নতুন data_pb2 ইম্পোর্ট করা হলো
from Pb2 import FreeFire_pb2, main_pb2, data_pb2

# === Flask App Setup ===
app = Flask(__name__)
# JSON আউটপুট সুন্দরভাবে সাজানোর জন্য সর্টিং বন্ধ করা হলো
...
async def GetAccountInformation(uid, unk, region, endpoint):
    ...
    async with httpx.AsyncClient() as client:
        ...
        # এখানে নতুন data_pb2 ফাইল ব্যবহার করে ডেটা ডিকোড করা হচ্ছে
        return json.loads(json_format.MessageToJson(decode_protobuf(resp.content, data_pb2.AccountPersonalShowInfo)))
...
def format_response(data):
    ...
    # নতুন data_pb2 থেকে পাওয়া অতিরিক্ত ইনফরমেশনগুলো
    ...
    return {
        "1. Player Information": {
            ...
            "Hippo_Rank": basic.get("hippoRank"),         # নতুন ইনফো
            "Hippo_Points": basic.get("hippoRankingPoints") # নতুন ইনফো
        },
        "2. Rank Information": {
            ...
            "CS_Rank_Entries": cs_rank_entries,           # নতুন ইনফো
            "MMR_Ratings": mmr_ratings                    # নতুন ইনফো
        },
        "3. Pet Information": {
        ...
        "6. Extended Stats & Info (NEW)": {
            "Region_Stats": region_stats,                 # নতুন ইনফো (Wins, Highest Rank ইত্যাদি)
            "Social_Highlights": highlights,              # নতুন ইনফো (Match Stats, Win percentage)
            "History_EP_Stats": history_ep                # নতুন ইনফো (Kills, Damage, Survival Time)
        },
        "7. Account Profile & Credit": {
            "Credit_Score": credit.get("score") or credit.get("creditScore"),
            "Credit_Status": credit.get("status"),        # নতুন ইনফো
            ...
            "Equipped_Achievements": achievements         # নতুন ইনফো
        }
    }
...
async def get_account_info():
    ...
    try:
        # ডিফল্টভাবে ME রিজিয়ন রাখা আছে (প্রয়োজনে ডায়নামিক করতে পারেন)
        region = "ME"
        ...
        return jsonify({"error": f"Invalid UID or server error: {e}"}), 500
