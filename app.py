...
# JSON এর ডাটা যাতে A-Z অনুযায়ী এলোমেলো না হয়, তার জন্য এই সেটিংটি অত্যন্ত জরুরি
...
def format_response(data):
    """সম্পূর্ণ ডেটাসহ এবং একদম প্রফেশনাল সিরিয়াল মেইনটেইন করা API রেসপন্স ফরমেট"""
    ...
    # এখানে যেভাবে সিরিয়াল করা আছে, আউটপুটেও ঠিক এভাবেই দেখাবে
    return {
        "PlayerInfo": {
